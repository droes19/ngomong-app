...
// SQLite to TypeScript Models Generator CLI
const path = require('path');
const { processMigrationDirectory, processFile } = require('../src/generators');
...
const defaultOutputDir = config.defaultPaths.models;
...
if (args.length === 0) {
  ...
  console.log('    sqlite-to-models --file <input-sql-file> [output-directory]');
  console.log('');
  console.log('  For a directory of migration files:');
  console.log('    sqlite-to-models --dir <migration-directory> [output-directory]');
  console.log('');
  console.log('  Default output directory if not specified:');
  console.log(`    ${defaultOutputDir}`);
  console.log('');
  console.log('Examples:');
  console.log('  sqlite-to-models --file database.sql');
  console.log('  sqlite-to-models --dir ./migrations ./src/custom/models');
  process.exit(1);
}
