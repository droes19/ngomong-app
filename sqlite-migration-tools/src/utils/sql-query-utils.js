/**
 * SQL query utilities for parsing and extracting named queries
 */
 ...
 * @returns {object} Object with query name as key and query content as value
 */
function extractNamedQueries(sqlContent) {
  const namedQueries = {};
  if (!sqlContent) {
    return namedQueries;
  }
