 ...
 * @returns {object|null} Object with version and description, or null if no match
 */
 ...
 * @param {string} fileName Name of the migration file
 * @returns {number|null} Version number or null if no match
 */
 ...
 * @returns {Array} Array of version objects with tables
 */
